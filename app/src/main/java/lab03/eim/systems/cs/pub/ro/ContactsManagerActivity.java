            ...
            switch(v.getId()){
                case R.id.fields_button:
                    switch (additionalFieldsContainer.getVisibility()){
                        case View.VISIBLE:
                            showHideAdditionalFieldsButton.setText(R.string.show_additional_fields);
                            additionalFieldsContainer.setVisibility(View.INVISIBLE);
                            break;
                        case View.INVISIBLE:
                            showHideAdditionalFieldsButton.setText(getString(R.string.hide_additional_fields));
...
//                    startActivity(intent);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       showHideAdditionalFieldsButton = findViewById(R.id.fields_button);
